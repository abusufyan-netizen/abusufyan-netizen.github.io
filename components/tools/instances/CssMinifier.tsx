    ...
    <div className="space-y-8">
      <div className="bg-white dark:bg-[#0D1526] border border-gray-100 dark:border-[#1E2D47] rounded-3xl p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-sm font-black uppercase tracking-widest text-gray-900 dark:text-white">CSS Input</h3>
        </div>
        ...
        >
          <Zap className="w-4 h-4" /> Minify CSS
        </button>
      </div>
      ...
      {minified && (
        <div className="bg-white dark:bg-[#0D1526] border border-gray-100 dark:border-[#1E2D47] rounded-3xl p-8 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xs font-black uppercase tracking-widest text-gray-400">Minified CSS</h3>
            <button 
          ...
          <div className="mt-4 text-[10px] font-black uppercase tracking-widest text-gray-400 text-center">
            Saved {Math.round((1 - minified.length / css.length) * 100)}% of original size
          </div>
        </div>
      )}
    </div>
