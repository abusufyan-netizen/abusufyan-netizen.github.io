...
import {
  ...
  DollarSign, ClipboardList, TrendingDown, Gauge, Share2
} from 'lucide-react'
...
const tools = [
  ...
  { name: 'Core Web Vitals Expert Guide', description: 'Interactive technical guide to mastering LCP, INP, and CLS performance', icon: Gauge, href: '/tools/core-web-vitals-guide', color: 'from-blue-600 to-purple-600', category: 'SEO', releaseDate: '2026-05-07' },
